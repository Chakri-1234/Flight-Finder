  ...
  return (
    <>
        ...
        {!usertype ? 
            ...
            <>
                <h3 >Indian flights</h3>

                <div className="nav-options" >
                    <p className="nav-color" onClick={()=>navigate('/')}>Home</p>
                    <p className="nav-color" onClick={()=>navigate('/auth')}>Login</p>
                </div>
        ...
        <>
            ...
            :  usertype === 'admin' ?
                    ...
                    <>
                        <h3 >Indian flights(Admin)</h3>
                        <div className="nav-options nav-bg" >
