...
const GeneralContextProvider = ({ children }) => {
  ...
  // New state for handling other context-related data
  const [homeBranch, setHomeBranch] = useState('');  // Example for other context data
  ...
  return (
    <GeneralContext.Provider
      value={{
        ...
        homeBranch,
        setHomeBranch,  // Added to the context provider value
      }}
    >
      {children}
    </GeneralContext.Provider>
